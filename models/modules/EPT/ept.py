...
@R.register('XTransEncoderAct_Uni')
class XTransEncoderAct_Uni(nn.Module):
...
class Transformer_Uni(nn.Module):
...
if __name__ == '__main__':
    ...
    model = Transformer_Uni(d_hidden, d_ffn, n_heads, n_layers, n_rbf, d_edge=d_edge, use_ieconv=True, use_edge_feat=True, efficient_ieconv=True, ieconv_share_edge_feat=False)
    model.to(device)
    model.eval()
